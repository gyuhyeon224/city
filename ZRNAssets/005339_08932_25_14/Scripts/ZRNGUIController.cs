...
public class ZRNGUIController : MonoBehaviour {
	...
	void OnGUI () {
		...
		if (menuVisible == true)
		{
			...
			if (GUI.Button (new Rect (20, 60, 80, 40), "Night"))
			{
			...
			if (GUI.Button (new Rect (200, 60, 80, 40), "Moon"))
			{
				this.GetComponent<AmbientController>().changeSkybox(AmbientController.AmbientType.AMBIENT_SKYBOX_MOON);
			}
